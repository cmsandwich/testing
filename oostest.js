window.gibinit = function() {
  ...
  function target_addToCart(DEBUG_NODE, UPC) {
    ...
    var cart = {"cart_type":"REGULAR","channel_id":"10","shopping_context":"DIGITAL","cart_item":{"tcin":UPC,"quantity":1,"item_channel_id":"10"},"fulfillment":{"type":"PICKUP","location_id":storeId,"ship_method":"STORE_PICKUP"}};
